...
import {tabVoucherStyles} from '../style/TichDiem.Style';

interface IProps extends ISettingState, IVoucherState {
...
class Voucher extends PureComponent<IProps> {
  ...
  renderListEmptyComponent = () => {
    ...
    if (isFirstLoading) {
      ...
      if (isError) {
        ...
        return <MyText style={tabVoucherStyles.txtAgain}>{MyI18n.trans.data_empty}</MyText>;
      }
    }
  };
  ...
  render() {
    ...
    let listVoucher = this.checkVoucher();
